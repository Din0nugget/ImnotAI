...
// =================================================
   const URL = "https://teachablemachine.withgoogle.com/models/2kpsdPc2J/";
...
// =================================================
   async function predict() {
      ...
      if (maxIndex === 0) {
        ...
        document.querySelector("#mainText2").textContent = "A performance artist from Thailand";
        document.body.style.backgroundColor = "rgb(255, 0, 157)"
      } 
      else if (maxIndex === 1) {
         document.querySelector("#mainText1").className = "variable2";
         document.querySelector("#mainText2").textContent = "Friday Feb 27";
        document.body.style.backgroundColor = "rgb(225, 255, 0)"
      } 
      else if (maxIndex === 2) {
         document.querySelector("#mainText1").className = "variable3";
         document.querySelector("#mainText3").textContent = "Come Join Us";
         document.body.style.backgroundColor = "rgb(0, 255, 187)"
